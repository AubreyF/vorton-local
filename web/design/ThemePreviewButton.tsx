...
import type { AppearanceDefinition as ThemeDefinition } from "./theme-registry";
    ...
    return (
      ...
      >
        <span
          ...
          data-theme-preview={theme.id === "starship-light" ? "starship" : theme.id === "starship-dark" ? "dark-star" : theme.id}
          aria-hidden="true"
        >
          <span
